...
<?php include_once('../Complementos/Header.php') ?>
    ...
    <div class="hd">
        <h4 style="border-bottom: 4px solid black;" class="car">Carrito ()</h4>
        <a href="listadeseos.php"><h4 class="fav">Favoritos()</h4></a>
            ...
            <div class="card"> 
                <div class="card-body">
                    <button type="button" class="close" aria-label="Close">
                        ...
                        <!-- Div que contiene los div nombre, precio, btn fav -->
                        <!-- <div class="cont"> -->
                        <!-- Div de Nombre y precio  -->
                            <div class="np">
                                <img class="card-img-top" src="zp.jpg">
                                <h4 >Nombre</h4>
                                <p class="card-text" type="number" >precio</p>
                            </div>
                        <!-- Div de boton fav y cantidad -->
                            <div class="btns">
