    ...
    <?php include_once('../Complementos/Header.php') ?>
     <body>  
             <div class="contenedor">
               ...
               <div class="container">
                    <a style="text-decoration: none;" href="CarritoCompras.php"><h3 class="text-left" id="carrito">Carrito:()</h3></a>
                    <h3 style="border-bottom: 4px solid black;" class="text-left">Favoritos:()</h3>
                </div>
